...
func setup(file string) {
	user := types.User{Id: "c85b4c8e-07ab-4c02-849d-71d495d6f905", Username: "Foobar", Ph: "+11234567890"}
...
// 	// skipping for now, as the base64 string will have too many possibilties due to the cipher text, hence making difficult to check the final string
// 	t.Run("Should successfully return a base64 string", func(t *testing.T) {
// 		user := types.User{Id: "c85b4c8e-07ab-4c02-849d-71d495d6f905", Username: "Foobar", Ph: "+11234567890"}
// 		got := GenQrCode(user)
// 		expected := "data:image/png;base64,"
